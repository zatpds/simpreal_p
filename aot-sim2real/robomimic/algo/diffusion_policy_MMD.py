...
class MMDDiffusionPolicyUNet(PolicyAlgo):
    def _create_networks(self):
        ...
        self.MMD_Loss = SamplesLoss("energy")
    ...
    def train_on_batch(self, batch, B_ot, ot_params, epoch, validate=False):
        ...
        with TorchUtils.maybe_no_grad(no_grad=validate):
            info = super(MMDDiffusionPolicyUNet, self).train_on_batch(batch, epoch, validate=validate)
            ...
            MMD_loss = self.MMD_Loss(ot_src_feat, ot_tgt_feat)
    ...
    def log_info(self, info):
        ...
        """
        log = super(MMDDiffusionPolicyUNet, self).log_info(info)

...
from robomimic.assets import assets_root
...
class TableArena(Arena):
    ...
    def __init__(
        ...
        super().__init__(os.path.join(assets_root, xml))
        ...
        if texture == "ceramic":
            self.table_visual.set("material", "table_ceramic")
        elif texture == "wood":
            self.table_visual.set("material", "table_wood")
            print("Using wood texture for table")

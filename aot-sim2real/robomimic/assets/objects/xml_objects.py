...
class PegWithBaseObject(MujocoXMLObject):
    ...
    def __init__(self, name):
        super().__init__(
            os.path.join(XML_ASSETS_BASE_PATH, "objects/peg_with_base.xml"),
            name=name,
            joints=[dict(type="free", damping="0.0005")],
            obj_type="all",
...
# class PegWithBaseScaleObject(MJCFObject):
#     """
#     Square nut object (used in NutAssembly)
#     """
#     def __init__(self, name, scale, density=100, friction=(1.0, 1.0, 1e-4)):
#         super().__init__(
#             name=name,
#             mjcf_path=os.path.join(XML_ASSETS_BASE_PATH, "objects/peg_with_base.xml"),
#             scale=scale,
#             density=density,
#             friction=friction,
#         )

class PegWithBaseTallObject(MujocoXMLObject):
    """
    Square nut object (used in NutAssembly)
    """
    ...
    def __init__(self, name):
        super().__init__(
            os.path.join(XML_ASSETS_BASE_PATH, "objects/peg_with_base_tall.xml"),
            name=name,
            joints=[dict(type="free", damping="0.0005")],
            obj_type="all",
            duplicate_collision_geoms=True,
...
class PegWithBaseTallTiltObject(MujocoXMLObject):
    """
    Square nut object (used in NutAssembly)
    """
    ...
    def __init__(self, name):
        super().__init__(
            os.path.join(XML_ASSETS_BASE_PATH, "objects/peg_with_base_tall_tilt.xml"),
            name=name,
            joints=[dict(type="free", damping="0.0005")],
            obj_type="all",
            duplicate_collision_geoms=True,
...
class SquareNutThickObject(MujocoXMLObject):
    ...
    def __init__(self, name):
        super().__init__(
            os.path.join(XML_ASSETS_BASE_PATH, "objects/square_nut_thick_multi_layer.xml"),
            name=name,
            joints=[dict(type="free", damping="0.0005")],
            obj_type="all",
            duplicate_collision_geoms=True,
...
# class SquareNutThickScaleObject(MJCFObject):
#     """
#     Square nut object (used in NutAssembly)
#     """
...
#         super().__init__(
#             name=name,
#             mjcf_path=os.path.join(XML_ASSETS_BASE_PATH, "objects/square_nut_thick.xml"),
#             scale=scale,
#             density=density,
#             friction=friction,
#         )
...
class DrawerRL2Object(MujocoXMLObject):
    ...
    def __init__(
            ...
            name,
            joints=None):
        path_to_cabinet_xml = os.path.join(XML_ASSETS_BASE_PATH, "objects/drawer_RL2.xml")
        super().__init__(path_to_cabinet_xml,
                         name=name, joints=None, obj_type="all", duplicate_collision_geoms=True)

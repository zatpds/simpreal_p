...
SRC_DATA_DIR = os.path.join(mimicgen.__path__[0], "~/atz/rs_collect/stack.hdf5")

# set base folder for where to copy each base config and generate new config files for data generation
CONFIG_DIR = "~/atz/rs_collect/core_configs"

# set base folder for newly generated datasets
OUTPUT_FOLDER = "~/atz/rs_collect/core_datasets"
